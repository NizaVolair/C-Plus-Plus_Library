...
**Date: 03-11-15
**Description: This is th header file for the book class
******************************************************************************/
#ifndef BOOK_HPP
#define BOOK_HPP
...
// These locations are mutually exclusive, but note that a Book can be on 
// request for a Patron while being checked out to another Patron. In that case
// the books location is CHECKED_OUT, and when it is returned, it's location 
// will become ON_HOLD_SHELF.
